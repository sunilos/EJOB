...
var CompanyCtl = require("./controller/CompanyCtl");
var JobCtl = require("./controller/JobCtl");
var CandidateCtl = require("./controller/CandidateCtl");
var JobApplicationCtl = require("./controller/JobApplicationCtl");
...
router.get('/:usecase', function (request, response) {
    callController(request, response, 'health');
});
